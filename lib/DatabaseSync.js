...
export default suite("Synchronous Connection", function() {
  ...
  //     test("getCollection(ns, coll) : Collection", function() {
  //       var coll = db.getCollection("myns", "mycoll");
  //
  ...
  //       });
  //       coll.db.must.be.same(db);
  //     });
  //
  //     test("getCollection(ns, coll, opts) : Collection", function() {
  //       var coll = db.getCollection("myns", "mycoll", {});
  //
  //       coll.must.be.instanceOf(Collection);
  //       coll.must.have({
  ...
  //       const coll = db.findCollection("myns", "mycoll");
  //
  //       coll.must.be.instanceOf(Collection);
  //       coll.must.have({
  //         name: "mycoll",
  ...
  //     });
  //
  //     test("findCollection(ns, coll, opts) : Collection", function() {
  //       const coll = db.findCollection("myns", "mycoll", {});
  //
  //       coll.must.be.instanceOf(Collection);
  //       coll.must.have({
  ...
  //     test("hasCollection(ns, coll) : true", function() {
  //       db.hasCollection("myns", "mycoll").must.be.eq(true);
  //     });
  //
